...
import com.zxing.utils.BitmapUtils;
...
//			openImageViewNum(random_num);

			openImageViewNum(resultString);
			closeCamera();//必须关闭摄像头之后再重新打开摄像头才能重复扫码

//			AlertDialog.Builder builder = new AlertDialog.Builder(this);
//			builder.setTitle("已解锁第" + random_num + "号");
//			builder.setMessage("已解锁第" + random_num + "号");
...
//			builder.show();
	...
	protected void restartCamera() {
		SurfaceView scanPreview = (SurfaceView) findViewById(R.id.capture_preview);
		initCamera(scanPreview.getHolder());
		// 恢复活动监控器
		inactivityTimer.onResume();
	}
	
	//暂时使用随机数来解锁，后期的逻辑代码这里还要修改
	private void openImageViewNum(String result) {
		switch (result) {
		case "1":
			iv_one.setImageResource(R.drawable.icon_one);
			showUnlockDialog(result);
			break;
		case "2":
			iv_two.setImageResource(R.drawable.icon_two);
			showUnlockDialog(result);
			break;
		case "3":
			iv_three.setImageResource(R.drawable.icon_three);
			showUnlockDialog(result);
			break;
		case "4":
			iv_four.setImageResource(R.drawable.icon_four);
			showUnlockDialog(result);
			break;
		case "5":
			iv_five.setImageResource(R.drawable.icon_five);
			showUnlockDialog(result);
			break;
		case "6":
			iv_six.setImageResource(R.drawable.icon_six);
			showUnlockDialog(result);
			break;
		case "7":
			iv_seven.setImageResource(R.drawable.icon_seven);
			showUnlockDialog(result);
			break;
		case "8":
			iv_eight.setImageResource(R.drawable.icon_eight);
			showUnlockDialog(result);
			break;
		case "9":
			iv_nine.setImageResource(R.drawable.icon_nine);
			showUnlockDialog(result);
			break;
		case "10":
			iv_ten.setImageResource(R.drawable.icon_ten);
			showUnlockDialog(result);
			break;
		default:
			break;
	 ...
	 * @param num
	 */
	private void showUnlockDialog(String num) {
		AlertDialog.Builder builder = new AlertDialog.Builder(this);
		builder.setTitle("已解锁第" + num + "号");
		builder.setMessage("已解锁第" + num + "号");
		builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
